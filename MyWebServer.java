...
1. Name / Date: Giries Hattar / 04/30/2020
...
class WebWorker extends Thread { // declaring the worker thread for the web server this is where the magic
	...
	public void run() {
		...
		try {
			...
			try {
				String name, request, fileName, fileType;
				String[] data;
	 ...
	 * background us
	 */
	static void show(String fileName, String fileType, PrintStream out, boolean dir)
			throws IOException {
